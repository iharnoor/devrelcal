 ...
 * AssemblyAI. Re-researched 2026-09-11 (Pacific morning) against each vendor's own events page.
...
export const vendorGroups: VendorGroup[] = [
  {
    ...
    watchNote:
      "Re-checked 2026-09-11: London Voice AI Exchange (Sep 10) pruned after day passed. Luma cal-qHEDltsO0Gr0WtD still lists Guess Who's Talking (Sep 14 SF, deepgram-xyix) and Voice AI: Shaping the Next Frontier of Customer Interaction (Oct 1 London, prkbq50k — Deepgram × Pipecat × frog). deepgram.com/speak still live for Speak '26 (Oct 29, The Aviary SF). Vapi×Deepgram BCN sunset drinks (Sep 22) + Web Summit Mixer (Nov 2) still confirmed. Hatch Designing for Voices (Sep 18) still live. deepgram.com/events 404s. Deepgram remains silver sponsor at AI Summit Barcelona (Sep 22–23) and diamond sponsor at VapiCon (Nov 11–12).",
  },
  {
    id: "cartesia",
    company: "Cartesia",
    ...
    events: [
      {
        ...
        format: "virtual",
        description:
          "Cartesia webinar on building voice agents for the India market — multilingual coverage across Indian languages, market context, and production lessons for teams shipping voice AI there. Re-listed on Cartesia Luma cal-EeDJt2cPbgGca1W (qyt0fc3o) as of 2026-09-11 after Farm to Table cleared.",
        status: "confirmed",
    ...
    watchNote:
      "Re-checked 2026-09-11: Farm to Table (Sep 10) and Maven AI Builders Summit Cartesia session (Sep 10) pruned after Pacific day passed. Cartesia Luma calendar now lists Field Notes: Voice AI in India webinar (Sep 16, qyt0fc3o). Cartesia CEO remains on the VapiCon speaker list.",
  },
  {
    id: "elevenlabs",
    company: "ElevenLabs",
  ...
  },
  {
    ...
    watchNote:
      "Re-checked 2026-09-11: Vapi Luma calendar cal-9jzVoVZclDCewDU still lists Behind the feature (Sep 22, ofrq557i), BCN executive dinner (Sep 23), early-stage sales dinner (Sep 24, skipped), Fleet Week yacht (Oct 8, skipped), Vapi×Deepgram Web Summit Mixer (Nov 2, Lisbon — tracked under Deepgram), and VapiCon (Nov 11). HumanX Amsterdam after-hours (Sep 23, d7jixwna) still live. VapiCon 2026 (Nov 11–12, Fort Mason SF) remains on the main calendar — Deepgram diamond sponsor; Cartesia CEO on the speaker list. Skip builders-sep26 (2025 Voice AI Builders Meetup slug trap).",
  },
  {
    id: "regal",
    company: "Regal AI",
    ...
    watchNote:
      "Re-checked 2026-09-11: Regal Rise (Sep 17 NYC/virtual) is still the dated public event (luma.com/regal-rise-2026). Adjacent contact-center Voice AI competitive signal vs AssemblyAI phone-agent builders — watch for a Bay Area follow-on.",
  },
  {
    id: "twilio",
    company: "Twilio",
    ...
    watchNote:
      "Twilio UK Luma calendar (2026-09-11) still surfaces Assemble London Nov 3 (7z0fyqec) plus Conversations-in-the-AI-era / coffee cowork meetups and Twilio Dev User Group London (Sep 17, f6jbqbec) — community builder rooms adjacent to Twilio. SIGNAL San Francisco 2026 is past (on-demand on signal.twilio.com/2026; 2027 interest form live). Watch twilio.com and Assemble announcements for US/Bay Area dates.",
  },
  {
    id: "agora",
    company: "Agora",
  ...
  },
  {
    ...
    events: [
      {
        ...
        description:
          "Paris engineering evening on production voice AI stacks — diarization (pyannoteAI), transcription (Gladia), and inference (Modal). Direct STT competitor mindshare play in EU; approval/waitlist on luma.com/paris-voice-ai as of 2026-09-11.",
        status: "confirmed",
    ...
    watchNote:
      "Re-checked 2026-09-11: NEW Paris Voice AI Meetup with pyannoteAI × Modal (Oct 14, paris-voice-ai) — first dated Gladia public room since RAISE Summit Paris (Jul 8–9). Direct STT competitor with EU residency positioning — also check gladia.io and @gladiaio.",
  },
  {
    id: "soniox",
    company: "Soniox",
  ...
  },
  {
    ...
    events: [],
    watchNote:
      "Luma calendar cal-xZRPdTa3UcyyNJE empty as of 2026-09-11 — The Direct Line Mumbai (Sep 8, e0vcvxo9) pruned after Pacific day passed. Past 2026 Bay Area pattern: Beyond Text research talks (Jun 8, Menlo Park), Voice AI Goes Global multilingual panel (Jun 15), CCW Las Vegas steakhouse afterhours with Telnyx (Jun 24), Voice AI HackSprint 2.0 (Mar 14, SF). Re-check weekly — they run SF/Menlo Park builder nights in bursts.",
  },
  {
    ...
    events: [],
    watchNote:
      "No Google-hosted dated speech/voice developer events isolated for Jul–Dec 2026 as of 2026-09-11 beyond general Cloud / Gemini sessions. Watch Google Cloud events and Gemini Live launch webinars; Open Model Hack (Gradient × DeepMind, Sep 12) is on the main calendar as adjacent open-model room.",
  },
  {
    id: "azure-ai-speech",
    ...
    events: [],
    watchNote:
      "No Azure AI Speech-specific dated Jul–Dec 2026 events confirmed as of 2026-09-11. Llama Lounge 26 (Sep 10, Microsoft MV) pruned after Pacific day passed — was a borrowed Microsoft campus room, not an Azure Speech product event. Watch Microsoft Reactor SF.",
  },
  {
    id: "aws-transcribe",
