 ...
 * AssemblyAI. Re-researched 2026-09-25 (Pacific morning) against each vendor's own events page.
...
export const vendorGroups: VendorGroup[] = [
  ...
  },
  {
    ...
    watchNote:
      "Re-checked 2026-09-25: Cartesia Luma cal-EeDJt2cPbgGca1W still lists Voice AI × Operators — London (Sep 30, 42d8c7mu) plus Drinks Around The Fire: Cartesia × Lorikeet (Oct 20 evening PT / Oct 21 UTC, bz8x2v1s — still skipped as social mixer). Cartesia CEO remains on the VapiCon speaker list.",
  },
  {
    id: "elevenlabs",
    company: "ElevenLabs",
  ...
  },
  {
    ...
    events: [],
    watchNote:
      "Re-checked 2026-09-25: Vapi Luma calendar cal-9jzVoVZclDCewDU — Sep 23/24 EU + sales dinner rooms pruned/past. Remaining: Fleet Week yacht (Oct 8, skipped), Deepgram × Vapi phone voice-agent workshop SF (Oct 14, deepgram-2jm5 — tracked under Deepgram + main calendar), Vapi×Deepgram Web Summit Mixer (Nov 2, Lisbon — tracked under Deepgram), VapiCon 2026 (Nov 11–12, Fort Mason SF — Deepgram diamond sponsor; Cartesia CEO on speaker list). Skip builders-sep26 (2025 Voice AI Builders Meetup slug trap).",
  },
  {
    id: "regal",
    company: "Regal AI",
    ...
    events: [],
    watchNote:
      "Re-checked 2026-09-25: Regal Rise (Sep 17 NYC/virtual) already pruned. No new dated public Regal events found — watch for a Bay Area follow-on vs AssemblyAI phone-agent builders.",
  },
  {
    id: "twilio",
    company: "Twilio",
  ...
  },
  {
    ...
    watchNote:
      "Re-checked 2026-09-25: SignalWire events + AICamp still list SF Sep 30 (W2026093017) and Palo Alto Oct 6 (W2026100615) as the near-term Bay Area builder rooms; Chicago Jun 24 workshop is past. Watch signalwire.com/resources/events for further city stops.",
  },
  {
    id: "livekit",
    company: "LiveKit",
    ...
    events: [],
    watchNote:
      "No dedicated public events page (livekit.io/events 404 as of 2026-09-25). LiveKit co-hosted AssemblyAI’s NYC Voice AI Meetup Sep 1 (pastEvents2026). LiveKit GM Robotics was on the panel for The Audio Layer 3.0: Voice x Robotics (Sep 15, pastEvents2026). Surfaces via Luma user LiveKit_Events and partner hackathons — re-check weekly around voice-agent forums.",
  },
  {
    id: "retell",
    company: "Retell AI",
    ...
    events: [],
    watchNote:
      "No public dated Jul–Dec 2026 developer events found on retellai.com/events as of 2026-09-25 (webinars grid empty). Typically appears at voice-agent conferences (VapiCon-class rooms) rather than running a dated Luma series. Check LinkedIn / retellai.com/blog.",
  },
  {
    id: "bland",
    company: "Bland AI",
  ...
  },
  {
    ...
    events: [],
    watchNote:
      "Re-checked 2026-09-25: Gemini Audio | At Night (Sep 24, The Pearl SF) pruned after Pacific day → pastEvents2026. No new dated Google Cloud Speech / Gemini Live Bay Area builder rooms on DeepMind Luma cal-7Q5A70Bz5Idxopu (remaining items are non-SF or non-speech). Watch Google Cloud events and Gemini Live launch webinars for follow-ons.",
  },
  {
    id: "azure-ai-speech",
    ...
    events: [],
    watchNote:
      "No Azure AI Speech-specific dated Jul–Dec 2026 events confirmed as of 2026-09-25. Llama Lounge 26 (Sep 10, Microsoft MV) pruned earlier — was a borrowed Microsoft campus room, not an Azure Speech product event. Watch Microsoft Reactor SF.",
  },
  {
    id: "aws-transcribe",
