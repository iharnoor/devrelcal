...
export const vendorGroups: VendorGroup[] = [
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        format: "virtual",
        description:
          "Short expert session on context graphs for decision-making workflows.",
        status: "confirmed",
        sourceUrl:
          "https://neo4j.com/event/ask-the-expert-context-graphs-and-decision-making/",
        sourceLabel: "neo4j.com",
        topics: ["graphrag"],
      },
      {
        ...
        format: "virtual",
        description:
          "Webinar on graph memory for supply-chain resilience in automotive parts intelligence.",
        status: "confirmed",
        sourceUrl:
      ...
      },
      {
        ...
        sortDate: "2026-09-04",
        format: "in-person",
        location: "Venue TBA — confirm on neo4j.com/event/agentsnexus-2026",
        description:
          "Neo4j-listed agent-focused conference (AgentsNexus 2026); venue not published on the events API listing.",
        status: "check-source",
  ...
  },
  {
    ...
    events: [
      ...
      {
        id: "langchain-loop-engineering-virtual",
        name: "The Art of Loop Engineering: Agents That Improve Over Time",
        dateLabel: "Jul 23",
        sortDate: "2026-07-23",
        format: "virtual",
        description:
